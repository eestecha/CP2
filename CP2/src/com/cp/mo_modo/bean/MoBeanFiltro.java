...
public class MoBeanFiltro extends StBean {
    ...
    public MoBeanFiltro(Object nulo) { super(); }
    ...
    public MoBeanFiltro coalesce(MoBeanFiltro pri, MoBeanFiltro sec) {
        MoBeanFiltro r = new MoBeanFiltro(null);
        if ( pri!=null && sec!=null ) {
		r.setMo_id_modo( (pri.getMo_id_modo()==null)?sec.getMo_id_modo():pri.getMo_id_modo() );	// id_modo
		r.setMo_colectivo( (pri.getMo_colectivo()==null)?sec.getMo_colectivo():pri.getMo_colectivo() );	// colectivo
		r.setMo_mo_nombre( (pri.getMo_mo_nombre()==null)?sec.getMo_mo_nombre():pri.getMo_mo_nombre() );	// mo_nombre
		r.setMo_json( (pri.getMo_json()==null)?sec.getMo_json():pri.getMo_json() );	// json
        }
        return r;
    }
    
    public void copyTo(MoBeanFiltro Destino) {
    ...
    public void copyFrom(MoBeanFiltro Origen) {
